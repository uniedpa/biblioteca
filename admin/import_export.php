...
<div class="box">
  ...
  <ul>
    ...
    <li>
      <a href="../circ/csv_template_member.csv"><?php echo $loc->getText("Plantilla de importacion de Miembros"); ?></a>
    </li>
</br>
    <li>
    ...
    <li>
      <a href="../catalog/csv_template.csv"><?php echo $loc->getText("Plantilla de importacion de Bibliografia"); ?></a>
    </li>
</br>
    <li>
    ...
    <li>
      <a href="../catalog/template_upload_usmarc.csv"><?php echo $loc->getText("import_bibliography_marc file"); ?></a>
    </li>
  </ul>
</div>
