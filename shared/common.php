...
//  if (get_magic_quotes_gpc()) { jalg /correcion de error 02082013 https://bitbucket.org/mstetson/obiblio/commits/4b75c4561091/
...
//  error_reporting(E_ALL ^ E_NOTICE); jalg /correcion de error 02082013 https://bitbucket.org/mstetson/obiblio/commits/4b75c4561091/
  $phpver = explode('.', PHP_VERSION); // jalg /correcion de error 02082013
  if ($phpver[0]==4) { // jalg /correcion de error 02082013
    error_reporting(E_ALL ^ E_NOTICE); // jalg /correcion de error 02082013
  } else { // jalg /correcion de error 02082013
    error_reporting(E_ALL & ~E_NOTICE & ~E_STRICT); // jalg /correcion de error 02082013
  } // jalg /correcion de error 02082013
