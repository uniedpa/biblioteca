...
$html_bottom='</iframe>';
//$raw_srcdoc='<html><body><p style="color:blue;">Hello World</p></body></html>';
$raw_srcdoc=$html_doctype.$html_head.$html_close_head.$html_open_table.$label_html.$html_close_table;
$srcdoc=htmlspecialchars($raw_srcdoc);
$html_top='<iframe name="etiquetas" id="etiquetas" width="100%" height="100%" frameborder=0 srcdoc="'.$srcdoc.'">';
$html=$html_top.$html_bottom;
echo $html_buttons.$html_script;
echo $html;
?>
